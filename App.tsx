...
                            <p className="font-semibold text-gray-400">Kéo và thả file tại đây</p>
                            <button type="button" onClick={onButtonClick}
                                className="mt-3 rounded-xl px-6 py-2 text-sm font-bold shadow-lg transition-colors transform hover:scale-[1.03] active:scale-[0.98]"
